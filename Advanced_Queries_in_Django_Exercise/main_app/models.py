...
class VideoGame(models.Model):
    ...
    release_year = models.PositiveIntegerField(
        validators=[MinValueValidator(limit_value=1990, message="The release year must be between 1990 and 2023"),
                    MaxValueValidator(limit_value=2023, message="The release year must be between 1990 and 2023")]
    )
