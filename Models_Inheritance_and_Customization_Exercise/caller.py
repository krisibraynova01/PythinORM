...
from main_app.models import BaseCharacter, Mage, Assassin, DemonHunter, TimeMage, Necromancer, ViperAssassin, \
    ShadowbladeAssassin, VengeanceDemonHunter, FelbladeDemonHunter, UserProfile, Message, Student, CreditCard, \
    SpecialReservation, Room, Hotel, RegularReservation, BaseReservation
